...
Lists in Python are Objects: The stuff list in our example is an instance of the list class. In OOP terms, stuff is an object, and list() is a class (blueprint). This means that stuff has all the properties and methods that the list class provides.

Methods (Actions):

When we call stuff.append('python'), we are using the method append that is defined in the list class. A method is simply a function that belongs to a class and can act on an object.
...
To learn OOP, we can follow these steps using the knowledge from your text:

Create Our Own Classes:

Just like Python has a list class, we can create our own classes to represent things in your program.
For example:
'''
class Car:
